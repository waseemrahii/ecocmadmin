...
<div className="mt-4">
  ...
  {showHealthList && (
   ...
   <div className="mt-4">
        <small className="block text-gray-400 uppercase">REPORT & ANALYSIS</small>
        <button
