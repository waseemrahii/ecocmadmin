      ...
      <div className="px-3 py-4">
        <div className="row align-items-center">
          ...
          <div className="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
            <Link
              to="#"
              className="btn border-green-400 hover:bg-green-400 hover:text-white"
            >
              <span className="text">Limited Stocks</span>
            </Link>
            <Link
              to="/inhouseaddproduct"
              className="btn flex justify-center items-center gap-3 bg-green-400 text-white hover:bg-green-500"
            >
              <FiPlus />
