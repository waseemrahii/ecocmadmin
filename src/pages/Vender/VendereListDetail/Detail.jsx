...
// //         // Fetch the vendor details from the API
// //         const response = await fetch(`${ApiUrl}vendors/66fba81e8136f7977c622d99`, {
// //           method: "GET",
// //           headers: {
...
// //           <img
// //             src={`${ImageApiUrl}/${vendorData.logo}`}
// //             alt="Shop Logo"
// //             className="w-32 h-32 rounded-full object-cover"
// //           />
// //           <div>
// //             <h1 className="text-2xl font-semibold">{vendorData.shopName}</h1>
...
// //               </h1>
// //               <h1>
// //                 <span>0</span> <span className="font-semibold"> Reviews</span>
// //               </h1>
// //             </div>
// //             <Link className="bg-blue-500 hover:text-white text-white px-4 py-2 rounded">
// //               View Live
// //             </Link>
// //           </div>
// //         </div>
...
// //               <tbody>
// //                 <tr>
// //                   <td className="px-4 py-2 text-nowrap">Shop Name :</td>
// //                   <td className="px-4 py-2">{vendorData.shopName}</td>
// //                 </tr>
// //                 <tr>
// //                   <td className="px-4 py-2">Phone :</td>
// //                   <td className="px-4 py-2">{vendorData.phoneNumber}</td>
// //                 </tr>
// //                 <tr>
// //                   <td className="px-4 py-2">Address :</td>
// //                   <td className="px-4 py-2">{vendorData.address}</td>
// //                 </tr>
// //                 <tr>
...
// //                   <td className="px-4 py-2">{vendorData.email}</td>
// //                 </tr>
// //                 <tr>
// //                   <td className="px-4 py-2">Phone :</td>
// //                   <td className="px-4 py-2">{vendorData.phoneNumber}</td>
...
// //           {/* Bank Information */}
// //           <div className="col-span-1 md:col-span-2 p-4 bg-[#F9FAFC] shadow rounded-lg mt-4">
...
// //                   <td className="px-4 py-2">Holder name :</td>
// //                   <td className="px-4 py-2">No data found</td>
// //                 </tr>
// //                 <tr>
// //                   <td className="px-4 py-2">Branch :</td>
// //                   <td className="px-4 py-2">No data found</td>
// //                   <td className="px-4 py-2">A/C No :</td>
// //                   <td className="px-4 py-2">No data found</td>
// //                 </tr>
// //               </tbody>
// //             </table>
...
//         <div className="col-span-1 md:col-span-6 grid grid-cols-1 md:grid-cols-2 gap-4 bg-white mt-4">
//           <div>
//             <h2 className="font-semibold text-[1.1rem] mb-2">Shop Information</h2>
//             <table>
//               <tbody>
//                 <tr>
//                   <td className="px-4 py-2 text-nowrap">Shop Name :</td>
...
//           {/* Seller Information */}
//           <div>
//             <h2 className="font-semibold text-[1.1rem] mb-2">Seller Information</h2>
//             <table className="min-w-full table-auto border-collapse">
//               <tbody>
//                 <tr>
//                   <td className="px-4 py-2">Name :</td>
    ...
    <div className="max-w-5xl mx-auto p-4 bg-white shadow rounded-lg">
      <div className="flex flex-col md:flex-row justify-between items-start mb-4">
        <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-4">
          ...
          />
          <div>
            <h1 className="text-xl md:text-2xl font-semibold">{vendorData.shopName}</h1>
